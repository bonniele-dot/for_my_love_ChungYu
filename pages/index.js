...
{confirmed && (
  <div className="flex flex-col items-center text-center w-full bg-pink-200 p-6">
    ...
    <div className="flex flex-col items-center gap-5 text-center w-full max-w-4xl bg-white p-6 mt-8 rounded-3xl shadow-xl">
      <img
        className="h-24"
      ...
      <h2 className="text-black font-bold text-xl sm:text-2xl underline leading-relaxed">
      ...
      {/* CONTRACT TEXT */}
      <div className="w-full text-left mt-6 space-y-10">
        <div>
        ...
        <div>
          ...
          <div className="w-full mt-4 bg-pink-50 border border-pink-100 rounded-2xl p-6">
